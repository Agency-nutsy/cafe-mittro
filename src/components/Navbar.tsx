    ...
    >
      <div className="container flex items-center justify-between h-16 md:h-20">
        <Link to="/" className="font-display text-2xl font-bold">
          <span className={showSolid ? "text-primary" : "text-white"}>Cafe</span>
          <span className={showSolid ? "text-foreground" : "text-white/80"}> Mittro</span>
        </Link>
              ...
              <Link
                ...
                className={`text-sm font-medium transition-colors relative py-1 ${
                  location.pathname === l.to
                    ...
                    : showSolid ? "text-muted-foreground hover:text-primary" : "text-white/70 hover:text-white"
                }`}
              >
                {l.label}
                {location.pathname === l.to && (
        ...
        <button
          ...
          className={`md:hidden p-2 ${showSolid ? "text-foreground" : "text-white"}`}
          ...
          >
            <ul className="flex flex-col p-4 gap-1">
              ...
              >
                <a
                  href={`tel:${PHONE}`}
                  className="flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-primary text-white text-sm font-semibold text-center mt-2"
                >
                  <Phone size={16} />
                  Call Us
                </a>
